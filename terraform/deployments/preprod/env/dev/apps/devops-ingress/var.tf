locals {
	...
	internal_services = ["requestd", "kibana-requestd"]
	internal_service_map = [
		{
			service_name : "elastic-requestd"
			domain : "elastic-requestd.${module.constants_cluster.cluster_shortname}"
		...
		},
		{
			...
			domain : "logs.${module.constants_cluster.cluster_shortname}"
			root_domain : module.constants.aex_i11l_systems_domain
			target_port : 5601
		},
		{
			service_name : "elastic-logs"
			domain : "elastic-logs.${module.constants_cluster.cluster_shortname}"
			root_domain : module.constants.aex_i11l_systems_domain
			source_port : 9200
			target_port : 9200
			is_secure : false
